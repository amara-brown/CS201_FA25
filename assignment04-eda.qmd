...
mydata <- ("animal_crossing.zip")
```

### Describe your data

Data author: Jessica Li

Link: <https://www.kaggle.com/datasets/jessicali9530/animal-crossing-new-horizons-nookplaza-dataset>

Description: "A comprehensive inventory of ACNH items, villagers, clothing, fish/bugs etc"
