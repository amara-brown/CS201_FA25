...
number8 <- penguins %>%
  ...
  dplyr::summarize(culmen_depth_mean = mean(culmen_depth_mm, na.rm = TRUE), culmen_length_mean = mean(culmen_length_mm, na.rm = TRUE))
...
across_filter <- penguins %>%
  ...
  dplyr::summarize(dplyr::across(where(is.numeric),max,na.rm = TRUE))
